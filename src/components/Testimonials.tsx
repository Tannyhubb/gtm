...
const testimonials = [
  ...
  {
    quote: "They didn't just throw money at ads; they genuinely understood our brand voice and built an organic social media presence that our audience actually cares about.",
